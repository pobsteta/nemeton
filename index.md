...
> **Analyse systemique de territoires forestiers selon la methode
> Nemeton**

`nemeton` est le package R coeur pour l’analyse integree d’ecosystemes
forestiers. Il calcule, normalise et visualise des **indicateurs
biophysiques multi-famille** pour la gestion forestiere durable.
