...
#' \itemize{
#'   \item \strong{C - Carbon/Vitality}: Biomass stock (C1), NDVI vitality (C2)
#'   \item \strong{W - Water}: Network density (W1), wetlands (W2), TWI (W3)
#'   \item \strong{F - Soil Fertility}: Fertility (F1), erosion risk (F2)
#'   \item \strong{L - Landscape}: Fragmentation (L1), edge ratio (L2)
#'   \item \strong{B - Biodiversity}: Planned for v0.3.0+
#'   \item \strong{R - Resilience/Risks}: Planned for v0.3.0+
#'   \item Plus 6 additional families in future versions
#' }
#'
...
#'
#' \itemize{
#'   \item \code{vignette("getting-started", package = "nemeton")} -
#'     Introduction to basic workflows with demo data
#'   \item \code{vignette("temporal-analysis", package = "nemeton")} -
#'     Multi-period analysis and change detection
#'   \item \code{vignette("indicator-families", package = "nemeton")} -
...
#'   \item \code{\link{indicator_carbon_biomass}} - Carbon stock (C1)
#'   \item \code{\link{indicator_carbon_ndvi}} - Vegetation vitality (C2)
#'   \item \code{\link{indicator_water_network}} - Hydrographic density (W1)
#'   \item \code{\link{indicator_water_wetlands}} - Wetland coverage (W2)
#'   \item \code{\link{indicator_water_twi}} - Topographic Wetness Index (W3)
#'   \item \code{\link{indicator_soil_fertility}} - Soil fertility (F1)
#'   \item \code{\link{indicator_soil_erosion}} - Erosion risk (F2)
#'   \item \code{\link{indicator_landscape_fragmentation}} - Fragmentation (L1)
#'   \item \code{\link{indicator_landscape_edge}} - Edge ratio (L2)
#' }
#'
#' \strong{Temporal Analysis:}
#' \itemize{
...
#'
#' \itemize{
#'   \item \strong{v0.2.0 (2026-01-05):} Multi-family system, temporal analysis,
#'     5 families implemented (C, W, F, L + infrastructure), 661 tests passing
#'   \item \strong{v0.1.0 (2026-01-04):} Initial release with 5 basic indicators,
#'     225 tests passing
#' }
#'
#' @section Links:
...
#'   \item Development: Branch \code{001-mvp-v0.2.0}
#' }
#'
#' @seealso
#' \strong{Vignettes:}
#' \itemize{
#'   \item \code{vignette("getting-started")} - Introduction and basic workflows
#'   \item \code{vignette("temporal-analysis")} - Multi-period analysis guide
#'   \item \code{vignette("indicator-families")} - 12-family reference guide
