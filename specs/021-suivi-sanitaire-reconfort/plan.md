...
| **L2b** | Scindé (cf. `L2b-cadrage.md`) en **L2b.1** fondations (env conda + glue + `RECONFORT_BANDS`) — ✅ **v0.72.0** ; **L2b.2** ingest IOTA²-natif (AOI→tuile + pygeodes) — ✅ **v0.73.0** ; **L2b.3** `run_reconfort_dieback()` orchestration | v0.72.0+ | L2a |
