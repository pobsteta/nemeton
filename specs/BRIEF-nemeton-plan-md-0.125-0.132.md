...
> **Statut** : **traité le 2026-08-22** — `PLAN.md` mis à jour (entrée de journal
> du 2026-08-22, chantiers A à E ; table des écarts refermée sur le seul n° 3 ;
> chantiers CLOS « table des familles » et « parcellaire ONF » complétés).
> Écarts relevés par rapport au brief : six des 25 releases étaient déjà
> consignées (v0.128.0, v0.128.1, v0.129.0, v0.130.0-v0.130.2) ; v0.124.1 et
> v0.124.2 manquaient dans les deux briefs et sont consignées ; le SHA de
> v0.132.0 est `37c8a539` (`ca363953` est l'objet tag) ; le §4.2 (T3
> `reference_year`) avait déjà été arbitré côté cœur le 2026-08-20.
