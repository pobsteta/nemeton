...
cat("=== Famille Énergie (E) ===\n\n")
cat("La biomasse forestière peut se substituer aux énergies fossiles :\n")
cat("  - Chauffage (bois bûche, plaquettes, granulés)\n")
cat("  - Cogénération (électricité + chaleur)\n")
cat("  - Biocarburants de 2ème génération\n\n")
