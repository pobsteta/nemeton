...
- **T02** : Métriques LiDAR → C1, C2, C3, P1, P3, E1, A1 (7 indicateurs)
...
familles <- data.frame(
  ...
  Indicateurs = c(
    "C1, C2, C3", "B1, B2, B3", "W1, W2, W3", "A1, A2",
    "F1, F2", "L1, L2, L3", "T1, T2", "R1, R2, R3, R4",
    "S1, S2, S3", "P1, P2, P3", "E1, E2", "N1, N2, N3"
  ),
  Nb = c(3, 3, 3, 2, 2, 3, 2, 4, 3, 3, 2, 3)
)
knitr::kable(familles, caption = "Les 12 familles d'indicateurs nemeton (33 indicateurs)")
```
...
# Liste des indicateurs attendus par famille
...
cat(paste(names(parcelles), collapse = ", "))
```
