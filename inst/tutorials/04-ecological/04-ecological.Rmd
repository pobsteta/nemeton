...
cat("\n2. Calcul des distances aux routes...\n")
...
if (!is.null(routes) && nrow(routes) > 0) {
  ...
  cat("   Distance min:", round(min(parcelles$dist_routes, na.rm = TRUE)), "m\n")
  cat("   Distance max:", round(max(parcelles$dist_routes, na.rm = TRUE)), "m\n")
} else {
