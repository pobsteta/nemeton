...
```{r ex-7-2, exercise=TRUE, exercise.eval=FALSE, exercise.lines=50, exercise.setup="ex-7-2-setup"}
...
```{r ex-7-4, exercise=TRUE, exercise.eval=FALSE, exercise.lines=55, exercise.setup="ex-7-4-setup"}
...
if (file.exists(fertilite_path)) {
  ...
  cat("   Score 0-1 (0=contraignant, 1=fertile)\n\n")
}
