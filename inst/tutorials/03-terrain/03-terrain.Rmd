---
title: "Tutorial 03 : Terrain — Familles W, R, S, P, F (12 indicateurs)"
output:
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
if (file.exists(mnt_path) && file.exists(parcelles_path)) {
  ...
  # Sauvegarder
  output_path <- file.path(data_dir, "metriques_fertilite_station_p2.gpkg")
  st_write(parcelles, output_path, delete_dsn = TRUE, quiet = TRUE)
  st_write(parcelles, parcelles_path, delete_dsn = TRUE, quiet = TRUE)
  cat("\n=== Métriques P2 Fertilité station exportées ===\n")
  cat("Fichier:", output_path, "\n")
  cat("Parcelles:", nrow(parcelles), " lignes et ", ncol(parcelles), " colonnes\n\n")
...
|---------|---------|-------------|
| `indicateurs_terrain.gpkg` | Synthèse complète | W1-3, R1-4, A1-3, P2, F1 |
...
| `metriques_fertilite_station_p2.gpkg` | Fertilité station | P2 |
| `twi.tif` | Raster TWI | - |
