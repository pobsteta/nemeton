...
cat("=== BABA vs Focal : Démonstration sur 4 dalles ===\n\n")
...
if (!requireNamespace("lasR", quietly = TRUE)) {
  ...
  output_baba <- file.path(output_dir_baba, "zmean_baba.tif")
  ...
  baba_result <- terra::rast(output_baba)
  ...
  if (!file.exists(chm_filled_vrt)) {
    ...
    # Charger le CHM filled et cropper sur l'emprise des 4 dalles
