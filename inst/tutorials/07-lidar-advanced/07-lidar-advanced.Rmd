...
# ==========================================================================
# 1. CHARGER LES ARBRES DEPUIS *_ArbresTerrain.csv (purrr)
# ==========================================================================
cat("--- 1. Chargement des arbres ---\n")

# Le nom du fichier contient directement le plot_id (ex: Verc-02-1_ArbresTerrain.csv)
...
# Charger les coordonnées des centres de placettes
coords <- dir(field_dir, pattern = "_PiquetsTerrain\\.csv$", full.names = TRUE) |>
  keep(~ any(str_detect(basename(.x), plots_in_extent))) |>
  map_dfr(~ {
    df <- read.table(.x, sep = ";", header = TRUE, stringsAsFactors = FALSE)
...
# Charger arbres depuis *_ArbresTerrain.csv (le nom contient le plot_id)
