...
#### 6.1.1 Inventaire à l'échelle de l'arbre
...
#### 6.1.2 Informations à l'échelle de la placette
...
#### 6.1.3 Calcul des coordonnées des arbres
...
### 6.2 Import des données LiDAR

#### 6.2.1 Extraction des nuages de points
...
### 6.3 Vérification des données d'inventaire

#### 6.3.1 Cohérence avec le protocole d'inventaire
...
#### 6.3.2 Allométrie hauteur-diamètre
...
#### 6.3.3 Positions des arbres et données LiDAR
...
### 6.4 Paramètres de peuplement

#### 6.4.1 Calcul des paramètres forestiers
