...
```{r ex-1-1, exercise=TRUE, exercise.eval=FALSE, exercise.lines=15}
# Charger les données
...
```{r ex-1-2, exercise=TRUE, exercise.eval=FALSE, exercise.lines=12, exercise.setup="ex-1-2-setup"}
...
```{r ex-1-3, exercise=TRUE, exercise.eval=FALSE, exercise.lines=18, exercise.setup="ex-1-3-setup"}
...
```{r ex-1-4, exercise=TRUE, exercise.eval=FALSE, exercise.lines=20, exercise.setup="ex-1-4-setup"}
...
```{r ex-1-5, exercise=TRUE, exercise.eval=FALSE, exercise.lines=25, exercise.setup="ex-1-5-setup"}
...
```{r viz-zone, exercise=TRUE, exercise.eval=FALSE, exercise.lines=20, exercise.setup="viz-zone-setup"}
...
```{r ex-3-2, exercise=TRUE, exercise.eval=FALSE, exercise.lines=22, exercise.setup="ex-3-2-setup"}
...
```{r ex-5-alt, exercise=TRUE, exercise.eval=FALSE, exercise.lines=20}
library(lidaRtRee)
data("quatre_montagnes", package = "lidaRtRee")
...
```{r ex-6-1, exercise=TRUE, exercise.eval=FALSE, exercise.lines=35, exercise.setup="ex-6-1-setup"}
# === INVENTAIRE DU CACHE ===
# Définir le répertoire de cache
if (requireNamespace("rappdirs", quietly = TRUE)) {
  data_dir <- file.path(rappdirs::user_data_dir("nemeton"), "tutorial_data")
