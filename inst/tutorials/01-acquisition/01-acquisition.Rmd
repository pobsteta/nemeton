...
La première étape consiste à charger notre **zone d'étude**. Le package nemeton fournit une zone prête à l'emploi dans `inst/extdata/zone_etude.gpkg`. Cette zone correspond au cluster **Verc-02** des données Quatre Montagnes avec un buffer de 500m, couvrant environ **450 hectares**.
