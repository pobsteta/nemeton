...
**Données requises** : Couches de zones protégées, diversité structurelle
**Source recommandée** : INPN, ZNIEFF, réserves naturelles
...
**Données requises** : Vecteurs routes, sentiers, équipements
**Source recommandée** : BD TOPO Routes, OpenStreetMap, IGN
