...
- 🌳 **Système multi-famille** : 12 familles d’indicateurs (5
  implémentées : C, W, F, L + infrastructure)
- 📊 **15 sous-indicateurs** : Carbone (C1, C2), Eau (W1-W3), Sols
  (F1-F2), Paysage (L1-L2) + legacy
...
- 🎯 **Agrégation flexible** : 4 méthodes (moyenne, pondérée,
  géométrique, harmonique)
- 🗺️ **Visualisations riches** : Cartes, radar multi-famille, tendances
  temporelles, heatmaps
