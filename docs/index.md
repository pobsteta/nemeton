...
- 🌳 **Système multi-famille** : 12 familles d’indicateurs (9
  implémentées : C, B, W, A, F, L, T, R + infrastructure)
- 📊 **25 sous-indicateurs** : Carbone (C1-C2), Biodiversité (B1-B3),
  Eau (W1-W3), Air (A1-A2), Sols (F1-F2), Paysage (L1-L2), Temporel
  (T1-T2), Risques (R1-R3) + legacy
...
- 🗺️ **Visualisations riches** : Cartes, radar multi-famille (jusqu’à 12
  axes), comparaisons, tendances temporelles
- 🔄 **Workflow intégré** : De la donnée brute aux indices composites
- 📦 **Production-ready** : 845+ tests, \>70% coverage, 100% backward
  compatible
