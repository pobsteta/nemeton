...
| **SC-003** | [`devtools::check()`](https://devtools.r-lib.org/reference/check.html) OK | Non testé      | ⏳     |
...
(probablement OK après fix tests) - 📊 Mesurer couverture de tests avec
`covr` - 📝 Optionnel: Ajouter
[`nemeton_radar()`](https://pobsteta.github.io/nemeton/reference/nemeton_radar.md)
(P3)
