...
**Release Date**: 2026-01-05 **Status**: ✅ Production Ready **Test
...
- **[`indicator_carbon_biomass()`](https://pobsteta.github.io/nemeton/reference/indicator_carbon_biomass.md)
  (C1)**: Allometric models for BD Forêt v2
...
- **[`indicator_soil_erosion()`](https://pobsteta.github.io/nemeton/reference/indicator_soil_erosion.md)
  (F2)**: Slope × cover protection risk
...
**✅ Full Backward Compatibility**: All v0.1.0 workflows continue to
work unchanged.
...
Pascal Obstétar Methodology: Nemeton systemic forest analysis
