...
`nemeton` is an R package for integrated analysis of forest ecosystems
from open spatial data. It implements the Nemeton method to calculate,
normalize, and visualize **multi-family biophysical indicators**
essential for sustainable forest management.

### ✨ Key Features

- 🌳 **Multi-family system**: 12 indicator families (5 implemented: C,
  W, F, L + infrastructure)
- 📊 **15 sub-indicators**: Carbon (C1, C2), Water (W1-W3), Soils
  (F1-F2), Landscape (L1-L2) + legacy
- ⏱️ **Temporal analysis**: Multi-period datasets, change rate
  calculation, visualizations
- 📈 **Advanced normalization**: min-max, z-score, quantiles, by family,
  with reference
- 🎯 **Flexible aggregation**: 4 methods (mean, weighted, geometric,
  harmonic)
- 🗺️ **Rich visualizations**: Maps, multi-family radar charts, temporal
  trends, heatmaps
- 🔄 **Integrated workflow**: From raw data to composite indices
- 📦 **Production-ready**: 661 tests, \>70% coverage, 100% backward
  compatible
...
- **v0.3.0** (Q1 2026): Families B, R, T, N (biodiversity, risks,
  dynamics, naturalness)
- **v0.4.0** (Q2 2026): Families S, P, A (social, productive, air
  quality)
- **v0.5.0** (Q3 2026): Family E, Shiny dashboard, complete framework

### 🤝 Contributing

Contributions are welcome! Please see: - [Technical
Specification](https://pobsteta.github.io/nemeton/articles/SPECIFICATION_TECHNIQUE.md) -
[Release
Instructions](https://pobsteta.github.io/nemeton/articles/RELEASE_INSTRUCTIONS.md) -
[GitHub Issues](https://github.com/pobsteta/nemeton/issues)

### 📜 License

MIT License - See
[LICENSE](https://pobsteta.github.io/nemeton/articles/LICENSE) file
...
The Nemeton method was developed by **Vivre en Forêt** for systemic
forest ecosystem assessment.

This package implements the method for reproducible spatial analysis
with open data.

------------------------------------------------------------------------

**Links**: - 🌐 Website: <https://pobsteta.github.io/nemeton/> - 📦
CRAN: *Coming soon* - 🐛 Issues:
<https://github.com/pobsteta/nemeton/issues> - 📰 Changelog:
[NEWS.md](https://pobsteta.github.io/nemeton/articles/NEWS.md)
