# Getting Started with nemeton

## Introduction

The `nemeton` package implements the Nemeton method for systemic forest
territory analysis. It provides tools to:

- Calculate 5 biophysical indicators (carbon, biodiversity, water,
...
This vignette demonstrates the complete workflow using the included
`massif_demo` synthetic dataset.
...
The package includes a synthetic forest dataset (`massif_demo`)
representing a 5km × 5km area with 20 forest parcels.
...
![Forest parcels by
type](getting-started_files/figure-html/unnamed-chunk-4-1.png)

Forest parcels by type

## Load Spatial Layers

Use
[`massif_demo_layers()`](https://pobsteta.github.io/nemeton/reference/massif_demo_layers.md)
to load all associated rasters and vectors:
...
- **4 rasters** (25m resolution): biomass, DEM, land cover, species
  richness
...
# Inspect results
names(results)
#>  [1] "parcel_id"     "forest_type"   "age_class"     "management"   
#>  [5] "surface_ha"    "geometry"      "carbon"        "biodiversity" 
#>  [9] "water"         "fragmentation" "accessibility"
```
...
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>   20.58   24.29   27.03   26.17   27.81   34.39
...
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  0.0000  0.1925  0.3200  0.3277  0.4685  0.7323
...
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>  0.7761  0.8455  0.8964  0.9076  0.9843  1.0000
```
...
normalized <- normalize_indicators(
  results,
  indicators = c("carbon", "biodiversity", "water", "fragmentation", "accessibility"),
  method = "minmax"
)
...
Convert accessibility to “wilderness” index (low access = high
wilderness):
...
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>   14.10   25.32   39.19   40.64   50.64   99.25
```
...
![Carbon stock
distribution](getting-started_files/figure-html/unnamed-chunk-13-1.png)
...
![Normalized biophysical
indicators](getting-started_files/figure-html/unnamed-chunk-14-1.png)

Normalized biophysical indicators
...
![Ecosystem health
index](getting-started_files/figure-html/unnamed-chunk-15-1.png)
...
The `nemeton` package provides a complete workflow for forest ecosystem
analysis:
