...
(its `foret_ancienne` argument). Two source forms are accepted:
...
- source:
  ...
  An sf/sfc of ancient-forest polygons, or a terra SpatRaster historical
  forest map.
...
An sf polygon layer with a single logical column
