...
#> 6 Spectral (α) diversity from Sentinel-2: heterogeneity of spectral species (Shannon) as a proxy for compositional diversity. Proxy pending field validation; a legitimate even-aged monospecific stand may score low.
