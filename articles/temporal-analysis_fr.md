...
#> [1] sf_1.0-24     dplyr_1.1.4   ggplot2_4.0.1 nemeton_0.8.0
#> 
...
#> [29] tools_4.5.2        vctrs_0.7.1        R6_2.6.1           proxy_0.4-29      
...
#> [53] htmltools_0.5.9    labeling_0.4.3     rmarkdown_2.30     compiler_4.5.2    
#> [57] S7_0.2.1
```
