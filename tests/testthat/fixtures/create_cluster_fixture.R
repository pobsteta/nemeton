...
cluster_test_data <- data.frame(
  ...
  family_C = c(85, 80, 88,  # Cluster 1
               50, 55, 52,  # Cluster 2
               20, 15, 25), # Cluster 3

  family_B = c(82, 87, 85,  # Cluster 1
               48, 52, 50,  # Cluster 2
               18, 22, 20), # Cluster 3

  family_P = c(78, 83, 80,  # Cluster 1
               45, 50, 48,  # Cluster 2
               25, 20, 22), # Cluster 3

  family_S = c(88, 85, 82,  # Cluster 1
               55, 52, 58,  # Cluster 2
               15, 18, 20)  # Cluster 3
)
...
expected_clusters_k3 <- c(1, 1, 1,  # Parcels 1-3 in cluster 1
                          2, 2, 2,  # Parcels 4-6 in cluster 2
                          3, 3, 3)  # Parcels 7-9 in cluster 3

# For k=2, combine clusters 2 and 3
expected_clusters_k2 <- c(1, 1, 1,  # High performers
                          2, 2, 2, 2, 2, 2)  # Medium+low performers
