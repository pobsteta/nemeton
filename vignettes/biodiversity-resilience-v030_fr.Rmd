...
*Note: Dans cette vignette, nous simulons les valeurs. Pour un usage réel, utilisez les fonctions `indicator_risk_fire()`, `indicator_risk_storm()`, `indicator_risk_drought()` et `indicator_risk_browsing()` avec des données DEM, climatiques et BD Forêt.*
