---
title: "Biodiversité, Résilience & Services Climatiques"
author: "Pascal Obstétar"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Biodiversité, Résilience & Services Climatiques}
...
*Note: Dans cette vignette, nous simulons les valeurs. Pour un usage réel, utilisez les fonctions `indicateur_r1_feu()`, `indicateur_r2_tempete()`, `indicateur_r3_secheresse()` et `indicateur_r4_abroutissement()` avec des données DEM, climatiques et BD Forêt.*
...
*Note: Utiliser `indicateur_t2_changement()` avec des rasters Corine Land Cover multi-dates pour un usage réel.*
...
*Note: Utiliser `indicateur_a1_couverture()` avec un raster de végétation pour un usage réel.*
...
*Note: Utiliser `indicateur_a2_qualite_air()` avec des données ATMO ou sources de pollution pour un usage réel.*
...
- Documentation API : `?indicateur_b1_protection`, `?nemeton_radar`, etc.
