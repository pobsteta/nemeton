...
**Validation terrain restante** (non cochée — exige un run réel, à confirmer par
Pascal) : sur `20260701_204501_ltcp` avec cache PAI, `njstress` doit prendre **plus
de deux** valeurs distinctes sur 30 UGF et l'étendue du LAI dérivé doit être non
nulle ; les critères B3 exigent de couper le réseau pendant le forçage SAFRAN et de
tuer le worker pour observer le post-mortem.
