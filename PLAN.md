...
**Suite côté app** (`nemetonshiny`, repo séparé — non fait ici) : plancher
`Imports: nemeton (>= 0.170.0)`, boucle sur la table dans `app_ui.R`, retrait
des 24 clés `famille_*`, test anti-redéclaration, correction du `CLAUDE.md` de
l'app. Cf. §6 du brief.
