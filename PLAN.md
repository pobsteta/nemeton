...
### E6.c — Pipeline FORDEAD (côté cœur `nemeton`) — **prochain gros chantier**

Spec 008 §3, plan.md §2, tasks.md chantiers E6.c.1 à E6.c.5.

- [ ] **E6.c.1** — `R/fordead_python.R` (helpers reticulate) + `R/fordead_pipeline.R` (orchestrateur `run_fordead_dieback`)
