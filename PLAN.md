...
> **Version `nemetonshiny` publiée** (vérifiée sur GitHub à chaque merge, `gh release list -R pobsteta/nemetonshiny`) : **v0.143.29** (release du 2026-09-23), `main` = `0.143.29`.
