...
**État au 2026-05-15** : `nemeton@main`, dernière release **v0.21.10** (tag à pousser, DESCRIPTION + NEWS.md alignés). Working tree propre. Pas de chantier d'épaississement actif.

Série de patches **v0.21.1 → v0.21.10** livrée entre 2026-05-12 et 2026-05-15. Le fil rouge est *« faire rentrer une ingestion S2 longue sans casse »* — les symptômes observés étaient des scènes silencieusement skippées, des hoquets DNS / 5xx fatals, un cache COG qui ne servait pas à grand-chose parce que la branche cache-hit plantait, et — dernier symptôme remonté par l'utilisateur le 2026-05-15 — des sous-rép `<cache_dir>/{scene_id}/` créés mais vides parce que le retry protégeait la mauvaise étape du pipeline.
